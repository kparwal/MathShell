...
public class MainActivity extends ActionBarActivity {
    ...
    public void add (View view) {
        ...
        TextView t = (TextView) findViewById(R.id.eqn);
        String equation =  t.getText().toString();
        intent.putExtra(EQUATION_MESSAGE, equation);
    ...
    public void text (View view) {
        ...
        t.setText(t.getText().toString() + buttontxt);
    }
